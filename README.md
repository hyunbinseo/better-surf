...
- 추적 파라미터 제거: 구글, 유튜브, 틱톡, 인스타그램, 스레드, 네이버, 아마존 등
- 애널리틱스 차단: [에어브릿지], [블럭스], [코드앤버터] 등

[에어브릿지]: https://www.airbridge.io/
[블럭스]: https://www.blux.ai/
[코드앤버터]: https://www.codenbutter.com/

| 기능                    | 적용 웹사이트             |
| ----------------------- | ------------------------- |
| 기계 번역 비활성화      | Reddit, 구글 기술 문서 등 |
| 링크 새 탭에서 열기     | 세종문화회관, 퀘이사존 등 |
| 보안 프로그램 강요 제거 | 인터넷우체국 등           |
| 불필요한 요소 숨김      | X/트위터, 네이버 웨일 등  |
| 업그레이드 안내 숨김    | Google Workspace          |
| 자바스크립트 링크 제거  | 퀘이사존 핫딜 등          |
